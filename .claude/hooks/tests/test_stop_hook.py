...
class TestStopHook:
    ...
    def test_no_state_file_stops(self, hook_runner, project_root) -> None:
    ...
    def test_max_iterations_stops(self, hook_runner, project_root) -> None:
    ...
    def test_recursion_guard(self, hook_runner, project_root) -> None:
    ...
    def test_pytest_fail_blocks(self, hook_runner, project_root) -> None:
    ...
    def test_precompact_stops(self, hook_runner, project_root) -> None:
    ...
    def test_state_schema_valid(self, project_root) -> None:
