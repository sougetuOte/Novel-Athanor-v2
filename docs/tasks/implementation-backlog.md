...
**ステータス**: ✅ P1タスク完了・レビュー承認済み（2026-01-25）
**詳細ガイド**: `docs/tasks/l2/implementation-guide.md`
...
| ID | タスク | 優先度 | 依存 | ステータス |
|----|--------|--------|------|-----------|
| L2-3-1 | 伏線状態遷移ロジック（registered→planted→reinforced→revealed） | P1 | L1-2-6 | ✅ |
...
**ステータス**: 📋 PLANNING 完了・BUILDING 準備中
**詳細ガイド**: `docs/tasks/l3/implementation-guide.md`（細粒度タスク 34件）

### L3 タスク概要（詳細は implementation-guide.md 参照）

| カテゴリ | P1タスク数 | P2タスク数 | ステータス |
|---------|-----------|-----------|-----------|
| L3-1: Scene Resolver | 5 | 0 | 🔲 |
| L3-2: Lazy Loader | 5 | 0 | 🔲 |
| L3-3: Phase Filter | 4 | 0 | 🔲 |
| L3-4: Context Integrator | 8 | 0 | 🔲 |
| L3-5: Foreshadow Instruction | 6 | 1 | 🔲 |
| L3-6: Visibility Integration | 4 | 0 | 🔲 |
| L3-7: Context Builder Facade | 5 | 0 | 🔲 |
| L3-8: AoT Parallel Collector | 0 | 4 | 🔲 (P2) |
| **合計** | **37** | **5** | |
...
| 旧ID | 新ID群 | タスク | ステータス |
|------|--------|--------|-----------|
| L3-1-1 | L3-1-1a〜L3-1-1e | シーン→関連ファイル特定ロジック | 🔲 |
| L3-1-2 | L3-2-1a〜L3-2-1e | Lazy Loader 実装 | 🔲 |
| L3-1-3 | L3-3-1a〜L3-3-1d | Phase Filter | 🔲 |
| L3-1-4 | L3-8-1a〜L3-8-2a | AoT Parallel Collector（P2） | 🔲 |
| L3-1-5 | L3-7-2a | Context Builder 統合テスト | 🔲 |
| L3-2-1 | L3-4-1a〜L3-4-3a | フィルタ済みコンテキスト構造体 | 🔲 |
| L3-2-2 | L3-5-1a〜L3-5-3a | 伏線指示書生成 | 🔲 |
| L3-2-3 | L3-5-2c | 禁止キーワードリスト統合 | 🔲 |
| L3-2-4 | L3-7-2a | コンテキスト統合テスト | 🔲 |
